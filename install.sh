...
if [ -d "/var/www/pterodactyl" ]; then
  ...
  case $action in
    1)
      ...
      bash <(curl -s https://raw.githubusercontent.com/sensei-this/pterodactyl-installer/main/modes/uninstall.sh)
...
if [ "$basic" == false ] && [ "$standard" == false ]; then
  ...
  [ "$panel" == true ] && bash <(curl -s https://raw.githubusercontent.com/sensei-this/pterodactyl-installer/main/modes/panel.sh)
  [ "$wings" == true ] && bash <(curl -s https://raw.githubusercontent.com/sensei-this/pterodactyl-installer/main/modes/wings.sh)
elif [ "$standard" == true ]; then
  bash <(curl -s https://raw.githubusercontent.com/sensei-this/pterodactyl-installer/main/modes/standard.sh)
else
  bash <(curl -s https://raw.githubusercontent.com/sensei-this/pterodactyl-installer/main/modes/basic.sh)
fi
